...
const basicScatterCode = `<ScatterPlot data={data} xKey="height" yKey="weight" xTitle="Height" yTitle="Weight"
  groupKey="gender" weightKey="shoeSize" showTrendline={false}
...
const BasicScatter = ({}) => {
  ...
  return (
    <ScatterPlot data={data} xKey="height" yKey="weight" xTitle="Height" yTitle="Weight"
      groupKey="gender" weightKey="shoeSize" showTrendline={false}
      axisColor="#FFF" tickColor="#FFF" gridColor="#FFF"
      labelColor="#FFF" graphTitleColor="#FFF" legendFontColor="#FFF"
