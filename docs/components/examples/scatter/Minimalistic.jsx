...
const minimalisticScatterCode = `let colors = ["#A2D4AB", "#3EACA8", "#547A82"]
<ScatterPlot data={data} xKey="height" yKey="weight" groupKey="gender" weightKey="shoeSize"
  showYAxisLine={false} color={colors}
/>`

const minimalisticScatterData = `const data = [
...
export {
  MinimalisticScatter,
  minimalisticScatterCode,
  minimalisticScatterData,
}
