...
const customColorScatterCode = `let colorMe = (i, group) => {
if (group === "male") {
    return "blue"
  } else {
    return "red"
...
<ScatterPlot data={data} xKey="height" yKey="weight" groupKey="gender" weightKey="shoeSize" color={colorMe}/>`

const customColorScatterData = `const data = [
...
export {
  CustomColorScatter,
  customColorScatterCode,
  customColorScatterData,
}
