...
const logarithmicScatterCode = `<ScatterPlot data={data} xKey="height" yKey="weight" groupKey="gender" weightKey="shoeSize"
  xScale="log" yScale="log"
/>`

const logarithmicScatterData = `const data = [
...
export {
  LogarithmicScatter,
  logarithmicScatterCode,
  logarithmicScatterData,
}
