...
const basicGroupedScatterCode = `<ScatterPlot data={data} xKey="height" yKey="weight" groupKey="gender" weightKey="shoeSize"/>`

const basicGroupedScatterData = `const data = [
...
export {
  BasicGroupedScatter,
  basicGroupedScatterCode,
  basicGroupedScatterData,
}
