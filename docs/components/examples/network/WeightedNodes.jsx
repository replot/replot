...
const weightedNodesNetworkCode = `<NetworkChart data={trades} parentKey="exporter" childKey="importer" height={450}
  nodes={nodes} nodeKey="country" nodeWeightKey="exports"
/>`

const weightedNodesNetworkData = `const trades = [
...
export {
  WeightedNodesNetwork,
  weightedNodesNetworkCode,
  weightedNodesNetworkData,
}
