...
const customColorNetworkCode = `const colorByExports = (node) => {
...
<NetworkChart data={trades} parentKey="exporter" childKey="importer" height={450}
  nodes={nodes} nodeKey="country" color={colorByExports}
/>`

const customColorNetworkData = `const trades = [
...
export {
  CustomColorNetwork,
  customColorNetworkCode,
  customColorNetworkData,
}
