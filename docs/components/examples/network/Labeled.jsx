...
const labeledNetworkCode = `<NetworkChart data={trades} parentKey="exporter" childKey="importer" height={450}
  nodes={nodes} nodeKey="country"
  showLabels={true} labelKey="country"
  labelColor="#FFF" labelFontSize={10}
/>`

const labeledNetworkData = `const trades = [
