...
const pastelNetworkCode = `const pastelColors = ["#ff6760", "#ffa0a2", "#f0e2e0", "#9ea30d"]
<NetworkChart data={trades} parentKey="exporter" childKey="importer" height={450}
  nodes={nodes} nodeKey="country" groupKey="region"
  color={pastelColors} lineColor="#FFF"
/>`

const pastelNetworkData = `const trades = [
...
const PastelNetwork = ({}) => {
  ...
  const pastelColors = ["#ff6760", "#ffa0a2", "#f0e2e0", "#9ea30d"]
  return(
