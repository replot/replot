...
const customTooltipNetworkCode = `const fillTooltip = (data) => {
  return(
    <div>
...
const customTooltipNetworkData = `const trades = [
...
const CustomTooltipNetwork = ({}) => {
  const fillTooltip = (data) => {
    return(
      <div>
        <span>The data for this node looks like: {JSON.stringify(data)}</span>
      </div>
...
export {
  CustomTooltipNetwork,
  customTooltipNetworkCode,
  customTooltipNetworkData,
}
