...
const weightedLinksNetworkCode = `<NetworkChart data={trades} parentKey="exporter" childKey="importer" height={450}
  weightedLinks={true} linkKey="volume"
/>`

const weightedLinksNetworkData = `const trades = [
...
export {
  WeightedLinksNetwork,
  weightedLinksNetworkCode,
  weightedLinksNetworkData,
}
