...
const basicGroupedLineCode = `<LineChart data={markets} groupKey="index" xKey="year" yKey="value"/>`

const basicGroupedLineData = `const markets = [
...
export {
  BasicGroupedLine,
  basicGroupedLineCode,
  basicGroupedLineData,
}
