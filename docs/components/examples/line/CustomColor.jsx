...
const customColorLineCode = `let colorMe = (i, group) => {
  if (group === "Dow Jones") {
    return "red"
  } else {
    return "grey"
...
<LineChart data={markets} groupKey="index" xKey="year" yKey="value" color={colorMe}/>`

const customColorLineData = `const markets = [
