...
const customTooltipLineCode = `let fillTooltip = (pointData, lineData) => {
  return(
    <span>The value for this point is {pointData.value}</span>
  )
}
...
const customTooltipLineData = `const markets = [
