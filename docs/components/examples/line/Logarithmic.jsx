...
const logarithmicLineCode = `<LineChart data={markets} groupKey="index" xKey="year" yKey="value" yScale="log"/>`

const logarithmicLineData = `const markets = [
