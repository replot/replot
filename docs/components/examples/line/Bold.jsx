...
const boldLineCode = `<LineChart data={markets} groupKey="index" xKey="year" yKey="value"
	lineWidth={5} pointWidth={10} axisWidth={4} tickWidth={4} gridWidth={4}
/>`

const boldLineData = `const markets = [
