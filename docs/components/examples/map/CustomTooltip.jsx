...
const customTooltipMapCode = `const fillTooltip = (title, data) => {
  return(
    <div>
...
<Map data={data} geoCode="code" weightKey="population" paths={USA}
  tooltipColor="light" tooltipContents={fillTooltip}
/>`

const customTooltipMapData = `const data = [
...
const CustomTooltipMap = ({}) => {
  const fillTooltip = (title, data) => {
    return(
      <div>
        <span>The name of this location is {title}.</span><br/>
        <span>The data for this location looks like: {JSON.stringify(data)}</span>
...
export {
  CustomTooltipMap,
  customTooltipMapCode,
  customTooltipMapData,
}
