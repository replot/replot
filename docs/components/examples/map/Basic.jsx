...
const basicMapCode = `<Map data={data} geoCode="code" weightKey="population"
  paths={WORLD} width="100%"
/>`

const basicMapData = `const data = [
...
const BasicMap = ({}) => {
  ...
  return (
    <Map data={data} geoCode="code" weightKey="population"
      paths={WORLD} width="100%"
    />
  )
}
